...
def define_my_model(num_of_variates, multi_variate_train_dataset, model_variant, freq, prediction_length):
    ...
    if (model_variant == "Transformer"):
        ...
        config = TimeSeriesTransformerConfig(
            ...
            lags_sequence=[1, 2, 3, 4, 5, 183+1, 183+2, 183+3, 183+4, 183+5],
        ...
        config = InformerConfig(
            ...
            lags_sequence=[1, 2, 3, 4, 5, 183+1, 183+2, 183+3, 183+4, 183+5, 366 + \
                           1, 366+2, 366+3, 366+4, 366+5, 549+1, 549+2, 549+3, 549+4, 549+5],
