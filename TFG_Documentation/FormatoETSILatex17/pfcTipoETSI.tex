...
% Ejemplo de Glosario
\newacronym[type=main]{ETSI}{ETSI}{Superior Technical College of Engineering}
\newacronym[type=main]{US}{US}{University of Seville}
...
\departamento{Department of Signal Theory and Communications}
\centro{Superior Technical College of Engineering}
\universidad{University of Seville}
\titulacion{Electronics, Robotics, and Mechatronics Engineering}
\fecha{2024}
\nombretrabajo{Final Degree Project} %Trabajo Fin de Grado, Proyecto fin de Máster,....
...
\include{1_ChapterIntroduction/1_ChapterIntroduction}
\include{2_ChapterHistory/2_ChapterHistory}
\include{3_ChapterTranformerVariants/3_ChapterTranformerVariants}
\include{4_ChapterMaterials/4_ChapterMaterials}
\include{5_ChapterDesign/5_ChapterDesign}
\include{6_ChapterResults/6_ChapterResults}
\include{7_ChapterConclusions/7_ChapterConclusions}

%\include{CapituloTransformer/CapituloTransformer}

%\include{CapituloTransformerTS/CapituloTransformerTS}
