...
data = df[['Temperature', 'Relative_humidity', 'Light', 'Soil_temperature',
           'Permittivity', 'Electroconductivity', 'Volumetric_water_content', 'Diameter', 'Battery_voltage']]
...
# data['Diameter'] = replace_incorrect_values(data['Diameter'], 100)
# data['Temperature'] = replace_incorrect_values(data['Temperature'], 0.6)
...
#       'Permittivity', 'Electroconductivity', 'Volumetric_water_content', 'Diameter', 'Battery_voltage']] = scaled_data
